  ...
  module Resource
    class InteractionActionTest < Minitest::Test
      def test_validation
        ...
        error = assert_raises(Errors::InvalidInteractiveActionReplyButton) do
          interactive_action = InteractiveAction.new(type: InteractiveAction::Type::ReplyButton)
          interactive_reply_button_1 = InteractiveActionReplyButton.new(title: "I am the button 1", id: "button_1")
          interactive_reply_button_2 = InteractiveActionReplyButton.new(title: "I am the button 2", id: "button_1")
      ...
      def test_to_json_reply_button
        ...
        interactive_reply_button = InteractiveActionReplyButton.new(title: "I am the button", id: "button")
