...
const config: Config = {
  ...
  tagline: 'Ruby SDK for WhatsApp Cloud API - Send messages, media, and manage your WhatsApp business',
  ...
  themeConfig: {
    ...
    footer: {
          ...
          items: [
            {
              ...
              href: 'https://stackoverflow.com/questions/tagged/whatsapp-sdk',
            },
            {
              label: 'RubyGems',
              href: 'https://rubygems.org/gems/whatsapp_sdk',
            },
          ],
        },
        {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Ruby WhatsApp SDK. Built with Docusaurus.`,
    },
    prism: {
